                                            ...
                                            <Col lg={9}>
                                                <div>
                                                    <div className="text-center">
                                                        <div>
                                                            <Link to={process.env.PUBLIC_URL + "/#"} className="logo">
                                                                <img src={logodark} height="57" alt="logo" className="logo-dark-element" />
                                                                <img src={logolight} height="57" alt="logo" className="logo-light-element" />
                                                            </Link>
                                                        </div>
                                                    ...
                                                    <div className="mt-5 text-center">
                                                        <p>Don't have an account ? <Link to={process.env.PUBLIC_URL + "/auth-login"} className="fw-medium text-primary"> Log in </Link> </p>
                                                    </div>
                                                </div>
                                            </Col>
                                        </Row>
