...
import SalesOrderListsTables from '../../../../components/Common/SalesListsTables/SalesOrderListsTables';
                        ...
                        <Row md="12">
                            ...
                            <Col md="3" className="d-inline">
                                <FormGroup>
                                    ...
                                    >
                                        <option value=""> Third parties with sales rep..</option>
                            ...
                            <Col md="3" className="d-inline">
                                <FormGroup>
                                    ...
                                    >
                                        <option value="">Linked to a Particular user..</option>
                                        <option value="1">Pending</option>
                                        <option value="2">Approved</option>
                                        <option value="3">Disapproved</option>
                                        <option value="4">Cancelled</option>
                            ...
                            <Col md="3" className="d-inline">
                                <FormGroup>
                                    ...
                                    >
                                        <option value="">Including products/Service with the..</option>
                                        <option value="1">Pending</option>
                                        <option value="2">Approved</option>
                                        <option value="3">Disapproved</option>
                                        <option value="4">Cancelled</option>
                            ...
                            <Col md="3" className="d-inline">
                                <FormGroup>
                                    ...
                                    >
                                        <option value=""> Cust/Prop, tags/categories..</option>
                                        <option value="1">Pending</option>
                                        <option value="2">Approved</option>
                                        <option value="3">Disapproved</option>
                                        <option value="4">Cancelled</option>
...
export default OrderSalesLists;