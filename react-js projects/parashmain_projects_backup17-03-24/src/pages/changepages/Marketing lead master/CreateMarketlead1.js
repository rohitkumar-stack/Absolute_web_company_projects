...
import { Row, Col, Card, CardBody, Container, Label, Form, Button, CardHeader } from "reactstrap";
//Import Breadcrumb
...
class CreateMarketingLead1 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            breadcrumbItems: [
                    ...
                    <Container fluid>
                        ...
                        <Card className="shadow">
                            <CardHeader className="text-white">
                                <h3 className="mb-0">Lead Form</h3>
                            </CardHeader>
                            <CardBody>
                                <AvForm className="needs-validation" onValidSubmit={this.handleSubmit}>
                                    {/* Lead Details */}
                                    <h5 className="section-title">Lead Details</h5>
                                    <Row>
                                        {[
                                            { label: 'Lead Topic', name: 'leadtopic' },
                                            { label: 'Lead Nature', name: 'leadnature' },
                                            { label: 'Lead Type', name: 'leadtype' },
                                            { label: 'Lead Status', name: 'leadstatus', type: 'select', options: ['Lead Status', 'Status 1', 'Status 2', 'Status 3'] },
                                    ...
                                    <h5 className="section-title mt-4">Lead Reference Details</h5>
                                    <Row>
                                        {[
...
export default CreateMarketingLead1;
