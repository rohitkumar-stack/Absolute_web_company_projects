...
class CreateMarketingLead4 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            breadcrumbItems: [
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <div className="bg-light" style={{ minHeight: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    <Container className="p-5">
                        ...
                        <AvForm className="needs-validation" onValidSubmit={this.handleSubmit}>
                            ...
                            <div className="text-center mt-4">
                                <Button color="primary" type="submit" className="m-2">
                                    Create Market Lead
                                </Button>
                                <Button className="m-2" color="secondary" onClick={() => this.props.history.goBack()}>
                                    Cancel
                                </Button>
                            </div>
                        </AvForm>
...
export default CreateMarketingLead4;
