...
class Duplicateviewleave extends Component {
    constructor(props) {
        super(props);
        this.state = {
            breadcrumbItems: [
        ...
        return (
            <React.Fragment>
                <div className="page-content">
                    <Container fluid>
                        <Breadcrumb title="View Leave Duplicate" breadcrumbItems={this.state.breadcrumbItems} />
                                    ...
                                    >
                                        <Row className="mt-2">
                                            <Col md="3" className="d-inline">
                                                ...
                                                <p>{this.state.getById.first_name + " " + this.state.getById.middle_name + " " + this.state.getById.last_name}</p>
                                            ...
                                            <Col lg="3">
                                                ...
                                                <p>{this.state.getById.start_date}</p>
                                                {/* <AvField
                                                    disabled
                                            ...
                                            <Col lg="3">
                                                ...
                                                <p>{this.state.getById.end_date}</p>
                                                {/* <AvField
                                                    disabled
                                        ...
                                        <Row>
                                            ...
                                            {this.state.getById.leave_id === "O9apoVGyLz5qNX4K" && (
                                             ...
                                             <Col lg="12">
                                                ...
                                                <p>{this.state.getById.leave_reason}</p>
...
export default Duplicateviewleave;
