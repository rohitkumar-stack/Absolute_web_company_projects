...
class EditIndustrialType extends Component {
    ...
    handleSubmit(event, values) {
        ...
        var Token = localStorage.getItem("userToken");
        try {
            fetch(UPDATE_INDUSTRIAL_TYPE + this.state.getById.id, {
                method: "POST",
                headers: {
                    Authorization: "Bearer " + Token,
                    "Content-Type": "application/json",
        ...
        return (
            <React.Fragment>
                <div className="page-content">
                    <Container fluid>
                        <Breadcrumb title="Edit Industrial Type" breadcrumbItems={this.state.breadcrumbItems} />
...
export default EditIndustrialType;
