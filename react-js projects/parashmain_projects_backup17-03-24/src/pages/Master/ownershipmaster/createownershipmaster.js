...
import { CREATE_DEPARTMENT, CREATE_DESIGNATION, CREATE_ITEM_CATEGORY, CREATE_ITEM_MAKER, CREATE_LEAD_REFERENCE, CREATE_LEAVE, CREATE_OWNERSHIP, CREATE_SHIFT, CREATE_SUBITEM_CATEGORY, CREATE_TERMS_CONDITIONS, CREATE_UNIT, CREATE_UNIT_MEASURE, CREATE_USER, CREATE_WAREHOUSE, GET_ITEM_CATEGORY } from "../../../globals";
...
class CreateOwnership extends Component {
    constructor(props) {
        ...
        this.state = {
            breadcrumbItems: [
                { title: "Ownership", link: process.env.PUBLIC_URL + "/leadTabs" },
                { title: "Create Ownership", link: process.env.PUBLIC_URL + "/#" },
            ],
            selectedFiles: [],
            Img: "",
            status: "Active",
            ...
            try {
                ...
                fetch(CREATE_OWNERSHIP, {
                    ...
                    response.json().then((data) => {
                        if (data.result === true) {
                            toast("Ownership Created Successfully !", {
                                type: "success",
                            });
                            ...
                            toast("Unable to Create Ownership", {
                                type: "error",
                            });
                        }
                    });
        ...
        return (
            <React.Fragment>
                <div className="page-content">
                    <Container fluid>
                        <Breadcrumb title="Add Ownership" breadcrumbItems={this.state.breadcrumbItems} />
                        <Card>
                            <CardBody>
                                <AvForm
                                    ...
                                    <Row className="mt-2">
                                        <Col lg="3">
                                            ...
                                            <AvField
                                                ...
                                                type="text"
                                                errorMessage="Please Provide Ownership Name"
