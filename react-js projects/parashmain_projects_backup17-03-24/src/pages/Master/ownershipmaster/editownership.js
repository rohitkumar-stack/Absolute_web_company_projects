...
class EditOwnership extends Component {
    constructor(props) {
        ...
        this.state = {
            breadcrumbItems: [
                ...
                { title: "Edit Ownership", link: process.env.PUBLIC_URL + "/#" },
            ],
    ...
    handleSubmit(event, values) {
        ...
        var Token = localStorage.getItem("userToken");
        try {
            fetch(UPDATE_OWNERSHIP + this.state.getById.id, {
                method: "POST",
                headers: {
                    Authorization: "Bearer " + Token,
                    "Content-Type": "application/json",
        ...
        return (
            <React.Fragment>
                <div className="page-content">
                    <Container fluid>
                        <Breadcrumb title="Edit Ownership" breadcrumbItems={this.state.breadcrumbItems} />
