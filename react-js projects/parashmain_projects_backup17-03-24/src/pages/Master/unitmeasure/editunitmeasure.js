...
import { CREATE_USER, GET_COUNTRY_BY_ID, GET_DEPARTMENT_BY_ID, GET_DESIGNATION_BY_ID, GET_HSN_CODE_BY_ID, GET_ITEM_CATEGORY, GET_ITEM_CATEGORY_BY_ID, GET_ITEM_MAKER_BY_ID, GET_ITEM_SUB_CATEGORY_BY_ID, GET_LEDGER_GROUP_BY_ID, GET_SHIFT_BY_ID, GET_TERMS_CONDITIONS_BY_ID, GET_UNIT_BY_ID, GET_UNIT_MEASURE_BY_ID, GET_USER_BY_ID, UPDATE_COUNTRY, UPDATE_DEPARTMENT, UPDATE_DESIGNATION, UPDATE_HSN_CODE, UPDATE_ITEM_CATEGORY, UPDATE_ITEM_MAKE, UPDATE_ITEM_SUB_CATEGORY, UPDATE_LEDGER_GROUP, UPDATE_SHIFT, UPDATE_TERMS_CONDITIONS, UPDATE_UNIT, UPDATE_UNIT_MEASURE, UPDATE_USER } from "../../../globals";
import { ThreeDots } from "react-loader-spinner";

class EditunitMeasure extends Component {
    constructor(props) {
        super(props);
        this.state = {
            breadcrumbItems: [
                { title: "Unit Measure", link: process.env.PUBLIC_URL + "/unitTabs" },
                { title: "Edit Unit Measure", link: process.env.PUBLIC_URL + "/#" },
            ],
    ...
    handleSubmit(event, values) {
        ...
        var Token = localStorage.getItem("userToken");
        try {
            fetch(UPDATE_UNIT_MEASURE + this.state.getById.id, {
                method: "POST",
                headers: {
                    Authorization: "Bearer " + Token,
                    "Content-Type": "application/json",
        ...
        return (
            <React.Fragment>
                <div className="page-content">
                    <Container fluid>
                        <Breadcrumb title="Edit Unit Measure" breadcrumbItems={this.state.breadcrumbItems} />
                                        ...
                                        <Row className="mt-2">
                                            <Col lg="3">
                                                ...
                                                <AvField
                                                    ...
                                                    name="name"
                                                    placeholder="Unit Measure Name"
                                                    type="text"
                                                    errorMessage="Please Provide Unit Measure Name"
