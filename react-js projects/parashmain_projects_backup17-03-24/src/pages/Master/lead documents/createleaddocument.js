...
class CreateLeadDocument extends Component {
    constructor(props) {
        super(props);
        this.state = {
            breadcrumbItems: [
                { title: 'Lead Document', link: process.env.PUBLIC_URL + '/leaddocumentlist' }, ,
                { title: "Create Lead Document", link: process.env.PUBLIC_URL + "/#" },
            ],
            selectedFiles: [],
            Img: "",
            status: "",
    ...
    handleSubmit(event, values) {
        ...
        try {
            ...
            fetch(CREATE_STATE, {
                ...
                response.json().then((data) => {
                    if (data.result === true) {
                        toast("Lead Document Created Successfully !", {
                            type: "success",
                        });
                        this.props.history.goBack();
                    } else {
                        toast("Unable to Create Lead Document", {
                            type: "error",
                        });
                    }
                });
        ...
        return (
            <React.Fragment>
                <div className="page-content">
                    <Container fluid>
                        <Breadcrumb title="Add Lead Document" breadcrumbItems={this.state.breadcrumbItems} />
                        <Card>
                            <CardBody>
                                <AvForm
...
export default CreateLeadDocument;
