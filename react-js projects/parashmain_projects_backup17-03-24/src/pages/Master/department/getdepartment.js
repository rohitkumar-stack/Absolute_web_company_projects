...
import { DELETE_USER, GET_ALL_USERS, GET_DEPARTMENT, GET_TERMS_CONDITIONS, UPDATE_DEPARTMENT_STATUS, UPDATE_TERMS_CONDITIONS_STATUS, UPDATE_USER_STATUS, getToken } from '../../../globals';
                    ...
                    <CardBody>
                        {isLoading ? (
                            ...
                            <TableComponent
                                ...
                                addData={CreateButton == "Active" ? "/createdepartment" : ""}
                                editData={EditButton == "Active" ? "/editdepartment/" : ""}
