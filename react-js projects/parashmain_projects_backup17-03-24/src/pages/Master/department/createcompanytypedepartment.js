...
import { CREATE_DEPARTMENT, CREATE_TERMS_CONDITIONS, GET_DESIGNATION, GET_AllDESIGNATIONCOMPANYWISE } from "../../../globals";
import CustomFileInputNew from "../../../components/Common/imagefunction";
import { Input } from "reactstrap";

class Createcompanytypedepartment extends Component {
    constructor(props) {
        super(props);
        this.state = {
            breadcrumbItems: [
                { title: "Department", link: process.env.PUBLIC_URL + "/departmentlist" },
                { title: "Create Department", link: process.env.PUBLIC_URL + "/#" },
            ],
            selectedFiles: [],
            Img: "",
            status: "Active",
                ...
                fetch(CREATE_DEPARTMENT, {
                    ...
                    response.json().then((data) => {
                        if (data.result === true) {
                            ...
                            toast("Unable to Create Department", {
                                type: "error",
                            });
                        }
                    });
        ...
        return (
            <React.Fragment>
                <div className="page-content">
                    <Container fluid>
                        <Breadcrumb title="Add Department" breadcrumbItems={this.state.breadcrumbItems} />
                        <Card>
                            <CardBody>
                                <AvForm
...
export default Createcompanytypedepartment;
