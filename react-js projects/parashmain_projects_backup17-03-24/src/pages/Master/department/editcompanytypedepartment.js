...
import { GET_AllDESIGNATIONCOMPANYWISE, UPDATE_DEPARTMENT_COMPANY, GET_DEPARTMENT_BY_ID, GET_HSN_CODE_BY_ID, GET_LEDGER_GROUP_BY_ID, GET_TERMS_CONDITIONS_BY_ID, GET_USER_BY_ID, UPDATE_COUNTRY, UPDATE_DEPARTMENT, UPDATE_HSN_CODE, UPDATE_LEDGER_GROUP, UPDATE_TERMS_CONDITIONS, UPDATE_USER } from "../../../globals";
import { ThreeDots } from "react-loader-spinner";

class Editcompanytypedepartment extends Component {
    constructor(props) {
        super(props);
        this.state = {
            breadcrumbItems: [
                { title: "Department", link: process.env.PUBLIC_URL + "/departmentlist" },
                { title: "Edit Department", link: process.env.PUBLIC_URL + "/#" },
            ],
    ...
    handleSubmit(event, values) {
        ...
        var Token = localStorage.getItem("userToken");
        try {
            fetch(UPDATE_DEPARTMENT_COMPANY + this.state.getById.id, {
                method: "POST",
                headers: {
                    Authorization: "Bearer " + Token,
                    "Content-Type": "application/json",
        ...
        return (
            <React.Fragment>
                <div className="page-content">
                    <Container fluid>
                        <Breadcrumb title="Edit Department" breadcrumbItems={this.state.breadcrumbItems} />
                                    ...
                                    >
                                        <Row className="mt-2">
                                            <Col lg="6">
                                                ...
                                                <AvField
                                                    value={this.state.getById.department_name}
                                                    name="name"
                                                    placeholder="Department Name"
                                                    type="text"
                                                    errorMessage="please Provide Department Name"
                                                ...
                                                <div className="mb-3">
                                                    ...
                                                    <AvField
                                                        value={this.state.getById.department_description}
                                                        name="description"
...
export default Editcompanytypedepartment;
