...
import { CREATE_USER, GET_COUNTRY_BY_ID, GET_DEPARTMENT_BY_ID, GET_DESIGNATION_BY_ID, GET_HSN_CODE_BY_ID, GET_ITEM_CATEGORY_BY_ID, GET_LEDGER_GROUP_BY_ID, GET_TERMS_CONDITIONS_BY_ID, GET_USER_BY_ID, UPDATE_COUNTRY, UPDATE_DEPARTMENT, UPDATE_DESIGNATION, UPDATE_HSN_CODE, UPDATE_ITEM_CATEGORY, UPDATE_LEDGER_GROUP, UPDATE_TERMS_CONDITIONS, UPDATE_USER } from "../../../globals";
...
class EditItemCategory extends Component {
    constructor(props) {
        ...
        this.state = {
            breadcrumbItems: [
                { title: "Item Category ", link: process.env.PUBLIC_URL + "/designationlist" },
                { title: "Edit Item Category", link: process.env.PUBLIC_URL + "/#" },
            ],
    ...
    handleSubmit(event, values) {
        ...
        var Token = localStorage.getItem("userToken");
        try {
            fetch(UPDATE_ITEM_CATEGORY + this.state.getById.id, {
                method: "POST",
                headers: {
                    Authorization: "Bearer " + Token,
                    "Content-Type": "application/json",
        ...
        return (
            <React.Fragment>
                <div className="page-content">
                    <Container fluid>
                        <Breadcrumb title="Edit Item Category" breadcrumbItems={this.state.breadcrumbItems} />
                                    ...
                                    >
                                        <Row className="mt-2">
                                            ...
                                            <Col lg="3">
                                                ...
                                                <AvField
                                                    value={this.state.getById.category_name}
                                                    name="name"
                                                    placeholder="Item Category Name"
                                                    type="text"
                                                    errorMessage="please Provide Item Category Name"
                                            ...
                                            <Col lg="4">
                                                <div className="mb-3">
                                                    ...
                                                    <AvField
                                                        value={this.state.getById.category_description}
                                                        name="description"
