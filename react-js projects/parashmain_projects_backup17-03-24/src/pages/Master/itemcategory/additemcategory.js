...
import { CREATE_DEPARTMENT, CREATE_DESIGNATION, CREATE_ITEM_CATEGORY, CREATE_TERMS_CONDITIONS, CREATE_USER } from "../../../globals";
...
class CreateItemCategory extends Component {
    constructor(props) {
        ...
        this.state = {
            breadcrumbItems: [
                { title: "Item Category", link: process.env.PUBLIC_URL + "/tabsItems" },
                { title: "Create Item Category", link: process.env.PUBLIC_URL + "/#" },
            ],
            selectedFiles: [],
            Img: "",
            status: "Active",
            ...
            try {
                ...
                fetch(CREATE_ITEM_CATEGORY, {
                    ...
                    response.json().then((data) => {
                        if (data.result === true) {
                            toast("Item Category Created Successfully !", {
                                type: "success",
                            });
                            ...
                            toast("Unable to Create Item Category", {
                                type: "error",
                            });
                        }
                    });
        ...
        return (
            <React.Fragment>
                <div className="page-content">
                    <Container fluid>
                        <Breadcrumb title="Add Item Category" breadcrumbItems={this.state.breadcrumbItems} />
                        <Card>
                            <CardBody>
                                <AvForm
                                        ...
                                        <Col lg="4">
                                            <div className="mb-3">
                                                ...
                                                <AvField
                                                    ...
                                                    type="textarea"
                                                    // errorMessage="please Provide Item Category"
                                                    className="form-control"
                                                    // validate={{ required: { value: true } }}
