...
import { DELETE_COUNTRY, DELETE_STATE, DELETE_USER, GET_ALL_USERS, GET_COUNTRY, GET_STATE, UPDATE_STATE_STATUS, getToken } from '../../../globals';
...
const GetStatelist = () => {
    ...
    const getAllUsers = async (page, perPage) => {
        ...
        try {
            const response = await fetch(page ? `${GET_STATE}?page=${page}` : `${GET_STATE}`, {
                method: 'GET',
                headers: {
    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <Breadcrumbs title="State list" breadcrumbItems={breadcrumbItems} />
                    ...
                    <CardBody>
                        {isLoading ? (
                            ...
                            <TableComponent
                                ...
                                btnName="Add State"
                                addData={CreateButton == "Active" ? "/createstate" : ""}
