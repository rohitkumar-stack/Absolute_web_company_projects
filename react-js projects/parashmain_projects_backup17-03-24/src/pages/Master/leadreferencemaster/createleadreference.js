...
class CreateLeadReference extends Component {
    constructor(props) {
        super(props);
        this.state = {
            breadcrumbItems: [
        ...
        return (
            <React.Fragment>
                <div className="page-content">
                    <Container fluid>
                        <Breadcrumb title="Add Lead reference" breadcrumbItems={this.state.breadcrumbItems} />
                        <Card>
                            <CardBody>
                                <AvForm
...
export default CreateLeadReference;
