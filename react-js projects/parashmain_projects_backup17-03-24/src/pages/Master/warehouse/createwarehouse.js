...
import { CREATE_DEPARTMENT, CREATE_DESIGNATION, CREATE_ITEM_CATEGORY, CREATE_ITEM_MAKER, CREATE_SHIFT, CREATE_SUBITEM_CATEGORY, CREATE_TERMS_CONDITIONS, CREATE_UNIT, CREATE_UNIT_MEASURE, CREATE_USER, CREATE_WAREHOUSE, GET_ITEM_CATEGORY } from "../../../globals";
    ...
    constructor(props) {
        ...
        this.state = {
            breadcrumbItems: [
                ...
                { title: "Create Warehouse", link: process.env.PUBLIC_URL + "/#" },
            ],
            selectedFiles: [],
            Img: "",
            status: "Active",
                ...
                fetch(CREATE_WAREHOUSE, {
                    ...
                    response.json().then((data) => {
                        if (data.result === true) {
                            ...
                            toast("Unable to Create Warehouse", {
                                type: "error",
                            });
                        }
                    });
        ...
        return (
            <React.Fragment>
                <div className="page-content">
                    <Container fluid>
                        <Breadcrumb title="Add Warehouse" breadcrumbItems={this.state.breadcrumbItems} />
                        <Card>
                            <CardBody>
                                <AvForm
