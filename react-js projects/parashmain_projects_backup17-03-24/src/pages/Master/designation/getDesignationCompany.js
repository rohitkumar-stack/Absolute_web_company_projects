...
const GetDesignationCompany = () => {
  ...
  console.log("checkselectedata", data);
      ...
      .then((response) => {
        response.json().then((data) => {
          if (data.result == true) {
            ...
            getAllDesignation();
            setisLoading(false);
            toast("Designation Cannot Be Updated", {
              type: "error",
            });
          }
        });
        ...
        <CardBody>
          ...
          {isLoading ? (
            ...
            <TableComponent
              ...
              addData={
                AddDesignation?.status == "Active" ? "/createdesignationcompany" : ""
              }
              editData={
                EditDesignation?.status == "Active" ? "/editdesignationcompany/" : ""
              }
...
export default GetDesignationCompany;
